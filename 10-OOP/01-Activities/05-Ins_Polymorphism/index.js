const OverloadDemo = function () {
  this.area = function (x, y) { // this function takes in two arguments in the parameter x and y
    console.log('x = ', x);
    if (!y) { // this syntax checks if a value is proved  if y is y it is defined and not null
